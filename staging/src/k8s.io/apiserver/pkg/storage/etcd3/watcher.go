...
func (w *watcher) Watch(ctx context.Context, key string, rev int64, recursive, clusterAsFirstSegment, progressNotify bool, pred storage.SelectionPredicate) (watch.Interface, error) {
